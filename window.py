...
def gui_window():
    ...
    def text_with_path(rely_value, folder):
        text = customtkinter.CTkTextbox(root_tk, fg_color='transparent')
        text.place(relx=0.2, rely=rely_value)
        text.insert(customtkinter.END, f'Default path - {folders_paths[folder]}')
